"""
Local Voice Agent for LiveKit (v1.3.6)
...
class VoiceAgent:
    ...
    async def entrypoint(self, ctx: JobContext):
        ...
        # Create Agent using new v1.3+ API
        # The Agent class wraps the voice pipeline functionality
        ...
        session = await assistant.start(ctx.room, chat_ctx=initial_chat_ctx)
